...
<ul class="parts list" id="symptomsUl"><li class="symptom-item  text-lg-start text-md-start text-sm-start  "><a href="http://localhost/xampp/help/child/header/Head injury in children.php" >Headache in children</a></li><li class="symptom-item  text-lg-start text-md-start text-sm-start "><a href="http://localhost/xampp/help/child/header/Headache in children.php" >Head injury in children</a></li></ul>
                </div>
            </div>
...
<ul class="parts list" id="symptomsUl"><li class="symptom-item text-lg-start text-md-start text-sm-start "><a href="http://localhost/xampp/help/child/ear nose throat/Sore throat.php" >Sore throat</a></li><li class="symptom-item text-lg-start text-md-start text-sm-start "><a href="http://localhost/xampp/help/child/ear nose throat/Treating allergic rhinitis in children.php" >Treating allergic rhinitis in children
</a></li></ul>
                </div>
            </div>
...
<ul class="parts list" id="symptomsUl"><li class="symptom-item text-lg-start text-md-start text-sm-start "><a href="http://localhost/xampp/help/child/chest%20and%20back/Cough%20in%20children.php" >Cough in children
</a></li><li class="symptom-item text-lg-start text-md-start text-sm-start "><a href="http://localhost/xampp/help/child/chest%20and%20back/Shortness%20of%20breath%20.php" >Shortness of breath </a></li></ul>
                </div>
            </div>
